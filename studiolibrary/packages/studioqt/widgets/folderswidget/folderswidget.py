...
class FoldersWidget(QtWidgets.QTreeView):
    ...
    def __init__(self, parent = None):
        ...
        self.connect(self.selectionModel(), QtCore.SIGNAL(signal), self._selectionChanged)
    ...
    def showCreateDialog(self, parent = None):
        ...
        :rtype: None
        """
        name, accepted = QtWidgets.QInputDialog.getText(parent, 'Create Folder', 'Folder name', QtWidgets.QLineEdit.Normal)
        name = name.strip()
    ...
    def showRenameDialog(self, parent = None):
        ...
        if folder:
            name, accept = QtWidgets.QInputDialog.getText(parent, 'Rename Folder', 'New Name', QtWidgets.QLineEdit.Normal, folder.name())
            if accept:
    ...
    def browseFolderIcon(self):
        ...
        :rtype: None
        """
        path, ext = QtWidgets.QFileDialog.getOpenFileName(self.parent(), 'Select an image', '', '*.png')
...
def example():
    path = 'C:/Users/Hovel/Dropbox/libraries/animation'
